...
// Water Note: Disable as it is bad for performance
...
board.geometry.clearGroups() // Since it is made up of its own material we need to get rid of it so we can put our own material
